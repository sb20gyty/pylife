...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", ".venv", "_build", "**.ipynb_checkpoints"]
...
try:
    from pylife import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
    (master_doc, 'pylife.tex', u'pyLife Documentation',
     u'pyLife Developer Team', 'manual'),
]
